This is _**[Markdown basic syntax](https://www.markdownguide.org/cheat-sheet/#extended-syntax).**_
### **V1.0**
----------
...
*TO-DO_12* - Make design more attracktive and labels texts more readable:
           1. labels s/b bold - **DONE**
           2. all fields and buttons s/b in the same style, fields borders 
             s/b rounded - **DONE**
           3. make labels in white color to see the difference - **DONE**
           4. find another image - **DONE**
